...
class NewResource(models.Model):
    ...
    ResourceID = models.CharField(max_length = 50, default = None, unique=True)
...
class CompleteOrder(models.Model):
    SystemID = models.ForeignKey(SystemIdentif, to_field='SystemID', on_delete=models.CASCADE)
    ResourceID = models.ForeignKey(NewResource, to_field='ResourceID', on_delete=models.CASCADE)
    OrderName = models.ForeignKey(Order, on_delete=models.CASCADE)
